...
public class ApiMethods {
    private static final Logger logger = LoggerFactory.getLogger(ApiMethods.class);
    ...
    public void setAccept(RequestSpecification requestSpecification, ConcurrentHashMap<String, Object> apiTestMap) {
        ...
        if (apiTestMap.containsKey("accept")) {
            ...
            // requestSpecification.accept(ContentType.valueOf(apiTestMap.get("accept").toString()).withCharset(StandardCharsets.UTF_8);
        }
    }
